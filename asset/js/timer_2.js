function TimerFunction(countDownDate) {
...
*/
		...
		var x = setInterval(function() {
			...
			var now = new Date().getTime(); // Getting todays date and time again for displaying the time change
...
var result_current_time = (now-time_Milliseconds_now);

			var distance = countDownDate - result_current_time; //millis difference between todays date-time and selected timer date-time
...
*/
			...
			if (distance < 0) {
				...
				setTimeout('document.End_timer_exam.submit()',1);
			}
		}, 1000);x
}
